...
// @description:ja    ニコニコ動画の動画再生終了後、次の動画へ遷移する前に自動的にキャンセルボタンをクリックします。再生終了時に全画面で視聴していた場合、それも自動的に解除します。「nicovideo-autoplay-canceler」「nicovideo-player-expander」は別のスクリプトです。
